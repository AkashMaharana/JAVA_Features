...
public class Student {
	...
	public String toString() {
		return "Student [studentName=" + studentName + ", designation=" + designation + ", activities=" + activities
	...
	public static List<Student> getListOfStudents() {
		...
		list.add(new Student("Akash", "SSE", Arrays.asList(new String[] { "Volleyball", "Baseball" }), 57));
		return list;
	}
